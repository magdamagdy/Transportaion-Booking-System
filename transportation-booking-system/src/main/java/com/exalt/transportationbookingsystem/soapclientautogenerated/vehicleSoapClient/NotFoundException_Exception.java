 ...
 * 
 */
@WebFault(name = "NotFoundException", targetNamespace = "http://client.soap.service.transportationbookingsystem.exalt.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: vehicleSoapClient.NotFoundException
     */
